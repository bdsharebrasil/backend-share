 ...
 */
export function calculateNightTime(flightDate, landingTime, latitude, longitude) {
    try {
 ...
 */
export function getSolarTimes(flightDate, latitude, longitude) {
    const date = new Date(`${flightDate}T00:00:00Z`);
    const times = SunCalc.getTimes(date, latitude, longitude);
    return {
 ...
 */
export function parseDMSCoordinate(dmsString) {
    try {
 ...
 */
export function calculateFlightMetrics(distanceLat1, distanceLon1, distanceLat2, distanceLon2, flightDate, landingTime) {
...
//# sourceMappingURL=flight-calculations.js.map